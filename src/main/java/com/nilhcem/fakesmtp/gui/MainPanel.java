...
public final class MainPanel {
   ...
   *
   * <p>To create the main panel, the method will first have to handle components interactions by
   ...
   *
   * <p>The interactions are the following:
   *
   * <ul>
   *   <li>Open the directory chooser when clicking on the menu/the save message field;
   *   <li>Enable/Disable the port field when the server starts;
   *   <li>Set the new directory, once a folder is selected;
   *   <li>
   *   <li>Notify components when a message is received;
   *   <li>Notify components when the user wants to clear them all.
   * </ul>
   *
   * @param menu the menu bar which will notify the directory file chooser.
   */
   ...
   *
   * <ul>
   *   <li>if the user has chosen a different port, then specifies it in the port text field.
   *   <li>if the user has chosen to auto-start the SMTP server, then it toggles automatically the
   *       "start server" button.
   * </ul>
   */
