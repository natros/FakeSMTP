...
public final class PortTextField extends Observable implements Observer {
   ...
   *
   * <p>The default port's value is defined in the configuration.properties file.<br>
   ...
   *
   * <p>When the element will receive an action from the {@link StartServerButton} object, it will
   * enable or disable the port, so that the user can't modify it when the server is already
   * launched.
   *
