...
public final class SaveMsgField extends Observable implements Observer {
  ...
  /**
   * Creates a text field and adds a mouse listener, to display the directory chooser dialog when a
   * user clicks on the field.
   *
   * <p>The text field will be disabled by default to avoid the user to type any folder directly.
   * <br>
   ...
   *
   * <p>Once a directory has been chosen by the {@link DirChooser}, the latter will notify this
   * class, so that it can update its content.
   *
