 ...
 *
 * <p>The directory chooser is used to select the folder where emails will be saved in.<br>
...
public final class DirChooser extends Observable implements Observer {
   ...
   *
   * @param parent the component from where the chooser will be launched <i>(should be the main
   *     panel of the application)</i>.
   */
  public DirChooser(Component parent) {
    ...
    dirChooser.setDialogTitle(
        String.format(
            I18n.INSTANCE.get("dirchooser.title"), Configuration.INSTANCE.get("application.name")));
   ...
   *
   * <p>This method will be called by an {@code Observable} element:
   *
   * <ul>
   *   <li>The {@link MenuBar};
   *   <li>Or the {@link SaveMsgField}.
   * </ul>
   *
   ...
   *
   * <p>The only observer notified is the {@link SaveMsgField}.
   */
