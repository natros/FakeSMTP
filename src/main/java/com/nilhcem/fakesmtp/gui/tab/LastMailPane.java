...
public final class LastMailPane implements Observer {
   ...
   *
   * <ul>
   *   <li>If the observable is a {@link MailSaver} object, the text area will contain the content
   *       of the last received email;
   ...
   * @param data optional parameters (an {@code EmailModel} object, for the case of a {@code
   *     MailSaver} observable).
   */
  @Override
