...
public final class LogsPane implements Observer {
   ...
   *
   * <ul>
   *   <li>If the observable is a {@link SMTPLogsObservable} object, the text area will display the
   *       received log.
   *   <li>If the observable is a {@link ClearAllButton} object, the text area will be cleared.
   * </ul>
   *
   * @param o the observable element which will notify this class.
   * @param log optional parameter (a {@code String} object, when the observable is a {@code
   *     SMTPLogsObservable} object, which will contain the log).
   */
  @Override
