 ...
 *
 * <p>This class will be instantiated only once and will use the JVM's default locale.
 *
 * @author Nilhcem
 * @since 1.0
 */
public enum I18n {
   ...
   *
   * <p>If the JVM's default locale doesn't have any resource file, will take the en_US resources
   * instead.
   */
  I18n() {
   ...
   *
   * <p>If the key is not found, returns an empty string.
   *
   * @param key a String representing the key we want to get the resource from.
   * @return The text corresponding to the key passed in parameters, or an empty string if not
   *     found.
   */
