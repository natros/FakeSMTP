...
public final class FakeSMTP {
   ...
   *
   * <p>Before opening the main window, this method will:
   *
   * <ul>
   *   <li>check command line arguments, and possibly display an error dialog,
   *   <li>set a default uncaught exception handler to intercept every uncaught exception;
   *   <li>use a custom icon in the Mac Dock;
   *   <li>set a property for Mac OS X to take the menu bar off the JFrame;
   *   <li>set a property for Mac OS X to set the name of the application menu item;
   *   <li>turn off the bold font in all components for swing default theme;
   *   <li>use the platform look and feel.
   * </ul>
   *
              ...
              try {
                ...
                if (envelopeImage != null) {
                  Application.getApplication()
                      .setDockIconImage(Toolkit.getDefaultToolkit().getImage(envelopeImage));
                }
              } catch (RuntimeException e) {
                LOGGER.debug(
                    "Error: {} - This is probably because we run on a non-Mac platform and these"
