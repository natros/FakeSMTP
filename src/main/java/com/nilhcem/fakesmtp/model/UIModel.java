 ...
 *
 * <p>The essence of a Presentation Model is of a fully self-contained class that represents all the
 * data and behavior of the UI window, but without any of the controls used to render that UI on the
 * screen.
 *
 * @author Nilhcem
...
public enum UIModel {
   ...
   *
   * <p>This method will notify the {@code SMTPServerHandler} to start the server.
   *
